...
const names=['basic','style','spans','position','paints','unicode','whitespace'];const output=new PNG({width:64*3*4,height:64*names.length*4});
...
}writeFileSync(new URL('text-panel.png',import.meta.url),PNG.sync.write(output));
