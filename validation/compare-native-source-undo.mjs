...
const root='/private/tmp/bend-svg-work',v=root+'/validation',candidate=root+'/source-undo-investigation';
const png=PNG.sync.read(readFileSync(v+'/native-source-undo-preview.png'));
